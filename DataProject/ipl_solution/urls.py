...
urlpatterns = [
    ...
    path("player-runs-graph/", views.player_runs_graph, name="player_runs_graph"),
    path("umpires-nationality/", views.umpire_nationality, name="umpire_nationality"),
    path("umpire-data/", views.umpire_data, name="umpire_data"),
    path("umpire-nation-graph/", views.umpire_nation_graph, name="umpire_nation_graph"),
    path(
        "matches-teams-season/", views.matches_teams_season, name="matches_teams_season"
    ),
    path("match-team-season-data/", views.match_team_season_data, name="match_team_season_data"),
    path("match-team-season-graph/", views.match_team_season_graph, name="match_team_season_graph")
]
